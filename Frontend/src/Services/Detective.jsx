...
import { Sparkles, Search, ArrowRight, Check, ShieldCheck, Fingerprint, Eye } from "lucide-react";
...
const Detective = () => {
  ...
  return (
    <div className="relative pt-24 pb-20 bg-[#FFF5F7] min-h-screen overflow-hidden font-sans selection:bg-[#FF4D6D] selection:text-white">
      ...
      {/* ✨ SOFT PINK & GOLD BACKGROUND ORBS */}
      <div className="absolute top-[-10%] left-[-5%] w-[600px] h-[600px] bg-gradient-to-br from-pink-300/40 to-yellow-200/20 rounded-full blur-[140px] -z-10 animate-pulse"></div>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center pt-10 mb-40">
          <div className="space-y-10 relative z-10">
            <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-white/60 backdrop-blur-xl border border-white/80 rounded-full shadow-sm">
              ...
              <span className="text-[11px] font-black text-[#FF4D6D] uppercase tracking-[0.2em]">Discrete Intelligence</span>
            </div>
            ...
            <p className="text-gray-500 text-xl md:text-2xl leading-relaxed max-w-lg font-medium">
              Beyond suspicion, closer to reality. Get undeniable proof and professional clarity with our <span className="text-[#333] font-bold underline decoration-pink-300 underline-offset-4">elite surveillance</span> and 100% confidential investigation protocols.
            </p>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white/40 backdrop-blur-sm p-4 rounded-[4rem] shadow-2xl border border-white/60 transform rotate-2 group-hover:rotate-0 transition-all duration-700">
              <div className="aspect-[4/5] rounded-[3.5rem] overflow-hidden shadow-inner bg-pink-50/50">
                <img 
                  src={detectiveImg} 
                  alt="Elite Private Investigation" 
              ...
              <div className="absolute -bottom-10 -right-6 bg-white p-6 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-pink-50 animate-bounce-slow">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-black text-[#2D2E5F]">Elite Audit</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mb-40 relative">
          ...
          <div className="max-w-xl mx-auto relative group">
            ...
            <div className="relative bg-white/80 backdrop-blur-2xl rounded-[3.5rem] p-12 md:p-16 border border-white shadow-2xl text-center">
              <h3 className="text-3xl font-black text-[#2D2E5F] mb-4">The Concierge Dossier</h3>
              <p className="text-gray-400 font-bold mb-10 tracking-[0.2em] uppercase text-[10px] italic">Deep Trace Investigation</p>
              
              <div className="mb-12 relative inline-block">
                <div className="absolute -top-4 -right-8 bg-[#FF4D6D] text-white text-[10px] font-black px-3 py-1 rounded-full uppercase">Priority</div>
                <span className="text-7xl font-black text-[#2D2E5F] tracking-tighter">₹16,999</span>
                <span className="text-gray-400 font-bold block mt-2 tracking-widest uppercase text-[10px]">Per Full-Scope Audit</span>
              </div>
              ...
              <div className="grid grid-cols-1 gap-5 mb-14 text-left px-4">
                {[
                  ...
                  "Professional Surveillance Report",
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {[
            { 
              ...
              desc: "Complete digital and physical trace monitoring of target activities.",
              icon: <Fingerprint className="w-7 h-7" />,
              gradient: "from-blue-400 to-indigo-500"
            },
            { 
              title: "Network Access", 
              desc: "Exclusive reach into private database networks for high-level data gathering.",
              icon: <ShieldCheck className="w-7 h-7" />,
              gradient: "from-amber-400 to-orange-500"
            },
            { 
              title: "Real-time Insight", 
              desc: "Direct intelligence reports for urgent cases requiring immediate action.",
