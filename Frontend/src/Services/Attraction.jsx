...
import { Sparkles, Zap, Eye, Flame, ArrowRight, Check, Star, Gem } from "lucide-react";

// 🖼️ इमेज इम्पोर्ट
import attractionImg from "../images/ChatGPT Image Apr 9, 2026, 12_43_28 PM.png";

const Attraction = () => {
  const navigate = useNavigate();

  const handleBookNow = () => {
    navigate("/contact", { state: { selectedService: "art-of-attraction" } });
  };
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center pt-10 mb-40">
          <div className="space-y-10 relative z-10">
            <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-white/60 backdrop-blur-xl border border-white/80 rounded-full shadow-sm">
              <Zap className="w-4 h-4 text-[#FF4D6D] fill-[#FF4D6D]" />
              <span className="text-[11px] font-black text-[#FF4D6D] uppercase tracking-[0.2em]">Mastery Program</span>
            </div>
            ...
            <p className="text-gray-500 text-xl md:text-2xl leading-relaxed max-w-lg font-medium">
              Don't just chase. <span className="text-[#333] font-bold underline decoration-pink-300 underline-offset-4">Attract.</span> Learn the secret psychology that makes you the most captivating person in any room.
            </p>
            ...
            >
              ...
              <span className="relative flex items-center gap-3 uppercase tracking-tighter">
                Master the Secret <ArrowRight className="group-hover:translate-x-2 transition-transform" />
              </span>
            </button>
          </div>

          {/* 🖼️ HERO IMAGE - With Glass Frame */}
              ...
              <div className="absolute -bottom-10 -right-6 bg-white p-6 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-pink-50 animate-bounce-slow">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-[#FF4D6D]/10 rounded-2xl flex items-center justify-center">
                    <Gem className="w-6 h-6 text-[#FF4D6D]" />
                  </div>
                  <div>
                    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Confidence</p>
                    <p className="text-xl font-black text-[#2D2E5F]">God Level</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mb-40 relative">
          ...
          <div className="max-w-xl mx-auto relative group">
            ...
            <div className="relative bg-white/80 backdrop-blur-2xl rounded-[3.5rem] p-12 border border-white shadow-2xl text-center">
              <h3 className="text-3xl font-black text-[#2D2E5F] mb-4">The Attraction Masterclass</h3>
              <p className="text-gray-400 font-bold mb-10 tracking-[0.2em] uppercase text-xs italic">Elite Transformation</p>
              
              <div className="mb-12">
                <span className="text-7xl font-black text-[#2D2E5F] tracking-tighter">₹9,999</span>
              ...
              <div className="grid grid-cols-1 gap-5 mb-14 text-left px-4">
                {[
                  "Psychological Aura Transformation",
                  "Advanced Body Language Secrets",
                  "The Art of Conversational Hypnosis",
                  "Fashion & Grooming Blueprint",
                  "Lifetime Social Skills Guide (PDF)"
                ].map((feature, i) => (
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {[
            { 
              title: "Body Language", 
              desc: "Learn how to speak without saying a single word.",
              icon: <Eye className="w-7 h-7" />,
              color: "from-amber-400 to-orange-500"
            },
            { 
              title: "Charisma Secrets", 
              desc: "The science of being the most liked person in any circle.",
              icon: <Sparkles className="w-7 h-7" />,
              color: "from-[#FF4D6D] to-[#E63958]"
            },
            { 
              title: "Social Dominance", 
              desc: "Take control of any conversation naturally and effortlessly.",
            ...
            <div key={idx} className="group bg-white p-12 rounded-[3rem] border border-pink-50/50 hover:bg-[#2D2E5F] transition-all duration-500 shadow-xl">
              <div className={`w-16 h-16 rounded-[1.5rem] bg-gradient-to-br ${item.color} flex items-center justify-center text-white mb-8 shadow-lg group-hover:scale-110 transition-transform`}>
                {item.icon}
              </div>
